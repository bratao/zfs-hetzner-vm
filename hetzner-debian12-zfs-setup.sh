...
c_default_rpool_tweaks="-o ashift=12 -O acltype=posixacl -O compression=zstd-2 -O dnodesize=auto -O relatime=on -O xattr=sa -O normalization=formD recordsize=1M"
